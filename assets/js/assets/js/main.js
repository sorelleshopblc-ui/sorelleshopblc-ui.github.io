document.addEventListener("DOMContentLoaded", () => {
  ...
  // Make product names approximately half their previous size.
  const productFontStyle = document.createElement("style");
  productFontStyle.textContent = `
    .product-copy h4 {
      margin-bottom: 8px;
  ...
  `;
  document.head.appendChild(productFontStyle);
